...
description: >-
  Add or update Japanese UI translations in a Blender add-on while preserving
  reload-safe registration. Use when an add-on needs localized labels,
  descriptions, panel text, operator text, or reports.
metadata:
  version: 1.0.0
---
# Blender Add-on i18n
