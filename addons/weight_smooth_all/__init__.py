...
def register() -> None:
    ...
    classes = (properties_module.WSA_Settings, operator_module.WSA_OT_smooth)
    ...
    bpy.types.Scene.weight_smooth_all = bpy.props.PointerProperty(type=properties_module.WSA_Settings)
    state["scene_prop"] = "weight_smooth_all"
